 ...
 *       &lt;sequence>
 *         &lt;element name="personHistory" type="{http://soap.assignment.introsde/}lifeStatus" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class ReadPersonHistoryResponse {
    ...
    protected List<LifeStatus> personHistory;
     ...
     * 
     */
    public List<LifeStatus> getPersonHistory() {
        if (personHistory == null) {
            personHistory = new ArrayList<LifeStatus>();
        }
